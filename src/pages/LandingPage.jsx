                ...
                <div className="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                  <div className="welcome-text">
                    ...
                    <h1 className="wow fadeInUp" data-wow-delay="0.6s">
                      Passing Your Apps Life<span>With Our Applic</span>
                    </h1>
                    ...
                    <div
                      className="home-button mt40 xs-mt40 wow fadeInUp"
                      data-wow-delay="1.2s"
                    >
              ...
              <div className="col-md-5 col-lg-5 col-sm-12 col-xs-12">
                <div className="area-content">
                  ...
                  <h3 className="wow fadeInRight" data-wow-delay="0.3s">
                    How Does This Apps Works
                  </h3>
                  <div
                    className="text-icon-box about-process-box wow fadeInUp mb40"
                    data-wow-delay="0.3s"
                  >
                    <div className="box-icon">
                      <i className="dripicons-user"></i>
                    </div>
                    <h4 className="font20">Create Account</h4>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                  ...
                  >
                    ...
                    <h4 className="font20">Download This Apps</h4>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                      sed do eiusmod tempor incididunt ut.
                    </p>
                  ...
                  >
                    ...
                    <h4 className="font20">Got Your Result</h4>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                      sed do eiusmod tempor incididunt ut.
                    </p>
